 ...
 * @see IRWAccess
 */
public final class OverlayRWAccess implements IRWAccess {
  private final IRWAccess writeAccess;
  private final List<IReadAccess> readAccessList;
  private final String DEFAULT_PATH_SEPARATOR = "/";
  private final String basePath;
  private static final Log logger = LogFactory.getLog( OverlayRWAccess.class );
  ...
  public List<IBasicFile> listFiles( String path, IBasicFileFilter filter, int maxDepth, boolean includeDirs, boolean showHiddenFilesAndFolders ) {
    ...
    result.addAll( writeAccess.listFiles( fullPath, filter, maxDepth, includeDirs, showHiddenFilesAndFolders ) );
